...
import br.elois.maktaba.fabreveal.widget.FabRevealFactory;
import br.elois.maktaba.fabreveal.reveal.SupportAnimator;
...
public class MaterialSheetAnimation {
    ...
    protected void startCircularRevealAnim(View view, int centerX, int centerY, float startRadius,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            // Setup animation
            SupportAnimator anim = br.elois.maktaba.fabreveal.reveal.ViewAnimationUtils
